...
void main() {
	...
	vs_out.fragNormalWorldSpace = mat3(globalMMatrix) * mat3(mMatrix) * vNormal;
	...
	vs_out.fragCoordWorldSpace = vec3(mMatrix * vec4(vPosition, 1.0f));
	...
	gl_Position = vpMatrix * globalMMatrix * mMatrix * vec4(vPosition, 1.0f);
}
