...
public class OBJ_FileLoader {
	...
	public static Illuminated_Model loadOBJ_File(String objPath, String matPath) {
		return loadOBJ_File(objPath, MTL_Loader.loadMaterialFromMTL(matPath));
	}
	
	
	
	public static Illuminated_Model loadOBJ_File(String objPath, Material material) {
